...
const (
    ...
    messageAppendix = "\n\n⚠️ Результаты распознавания и определения основаны на сервисах Google Cloud Vision и Google Cloud Translation. За любые несоответствия фактического названия гриба и результатов распознавания ответственно указанное решение и его производитель. Мы рекомендуем вам брать только те грибы, в которых вы уверены на 100 %."
)
